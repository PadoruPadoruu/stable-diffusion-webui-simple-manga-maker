(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        !function(t) {
            t.CrayonBrush = t.util.createClass(t.BaseBrush, {
                color: "#000000",
                opacity: .6,
                width: 30,
                _baseWidth: 20,
                ...
                initialize: function(i, s) {
                    s = s || {},
                    this.canvas = i,
                    this.width = s.width || i.freeDrawingBrush.width,
                    this.color = s.color || i.freeDrawingBrush.color,
                    this.opacity = s.opacity || i.contextTop.globalAlpha,
                    this._point = new t.Point(0,0)
                },
                ...
                set: function(i) {
                    this._latest ? this._latest.setFromPoint(this._point) : this._latest = new t.Point(i.x,i.y),
                    t.Point.prototype.setFromPoint.call(this._point, i)
                },
                update: function(t) {
                    this.set(t),
                    this._latestStrokeLength = this._point.subtract(this._latest).distanceFrom({
                        x: 0,
                        y: 0
                    })
                },
                draw: function(i) {
                    var s, o, e, n, a, h, l, c, r, u, p, _, d, f, g;
                    for (u = this._point.subtract(this._latest),
                    p = Math.ceil(this._size / 2),
                    _ = Math.floor(u.distanceFrom({
                        x: 0,
                        y: 0
                    }) / p) + 1,
                    u.normalize(p),
                    d = this._sep * t.util.clamp(this._inkAmount / this._latestStrokeLength * 3, 1, .5),
                    f = Math.ceil(this._size * this._sep),
                    g = this._size / 2,
                    i.save(),
                    ...
                    s = 0; f > s; s++)
                        for (o = 0; _ > o; o++)
                            e = this._latest.add(u.multiply(o)),
                            n = t.util.getRandom(g),
                            a = t.util.getRandom(2 * Math.PI),
                            c = t.util.getRandom(d, d / 2),
                            r = t.util.getRandom(d, d / 2),
                            h = e.x + n * Math.sin(a) - c / 2,
                            l = e.y + n * Math.cos(a) - r / 2,
                            i.rect(h, l, c, r);
                    i.fill(),
                    i.restore()
                }
    ...
    2: [function(require, module, exports) {
        !function(t) {
            t.Drip = t.util.createClass(t.Object, {
                rate: 0,
                color: "#000000",
                amount: 10,
                life: 10,
                ...
                _strokeId: 0,
                _interval: 20,
                initialize: function(i, e, n, o, s) {
                    this.ctx = i,
                    this._point = e,
                    this._strokeId = s,
                    this.amount = t.util.getRandom(n, .5 * n),
                    this.color = o,
                    this.life = 1.5 * this.amount,
                    i.lineCap = i.lineJoin = "round",
                    this._render()
                },
                _update: function(i) {
                    this._lastPoint = t.util.object.clone(this._point),
                    this._point.addEquals({
                        x: this.life * this.rate,
                        y: t.util.getRandom(this.life * this.amount / 30)
                    }),
                    this.life -= .05,
                    t.util.getRandom() < .03 ? this.rate += t.util.getRandom(.03, -.03) : t.util.getRandom() < .05 && (this.rate *= .01)
                },
                _draw: function() {
                    this.ctx.save(),
                    this.line(this.ctx, this._lastPoint, this._point, this.color, .8 * this.amount + .2 * this.life),
                    this.ctx.restore()
                },
                _render: function() {
                    function t() {
                        i._update(),
                        i._draw(),
                        i.life > 0 && setTimeout(t, i._interval)
                    }
                    var i = this;
                    setTimeout(t, this._interval)
                },
                line: function(t, i, e, n, o) {
                    t.strokeStyle = n,
                    t.lineWidth = o,
                    t.beginPath(),
                    t.moveTo(i.x, i.y),
    ...
    3: [function(require, module, exports) {
        !function(t) {
            t.InkBrush = t.util.createClass(t.BaseBrush, {
                color: "#000000",
                opacity: 1,
                width: 30,
                _baseWidth: 20,
                ...
                changeOpacity: function(t) {
                    this.opacity = t,
                    this.canvas.contextTop.globalAlpha = t
                },
                _render: function(i) {
                    var s, o, n, e, h, r, a;
                    for (this._strokeCount++,
                    this._strokeCount % 120 === 0 && this._dripCount < 10 && this._dripCount++,
                    n = this.setPointer(i),
                    s = n.subtract(this._lastPoint),
                    o = n.distanceFrom(this._lastPoint),
                    r = this._strokes,
                    e = 0,
                    h = r.length; h > e; e++)
                        a = r[e],
                        a.update(n, s, o),
                        a.draw();
                    o > 30 ? this.drawSplash(n, this._inkAmount) : 10 > o && t.util.getRandom() < .085 && this._dripCount && (this._drips.push(new t.Drip(this.canvas.contextTop,n,t.util.getRandom(.25 * this.size, .1 * this.size),this.color,this._strokeId)),
                    this._dripCount--)
                },
                onMouseDown: function(i) {
                    this._resetTip(i),
                    this._strokeId = +new Date,
                    this._dripCount = 0 | t.util.getRandom(6, 3)
                },
                onMouseMove: function(t) {
                    this.canvas._isCurrentlyDrawing && this._render(t)
                },
                onMouseUp: function() {
                    this._strokeCount = 0,
                    this._dripCount = 0,
                ...
                drawSplash: function(i, s) {
                    var o, n, e, h, r = this.canvas.contextTop, a = t.util.getRandom(12), u = 10 * s, l = this.color;
                    for (r.save(),
                    e = 0; a > e; e++)
                        n = t.util.getRandom(u, 1),
                        o = t.util.getRandom(2 * Math.PI),
                        h = new t.Point(i.x + n * Math.sin(o),i.y + n * Math.cos(o)),
                        r.fillStyle = l,
                        r.beginPath(),
                        r.arc(h.x, h.y, t.util.getRandom(s) / 2, 0, 2 * Math.PI, !1),
                        r.fill();
                    r.restore()
                },
                setPointer: function(i) {
                    var s = new t.Point(i.x,i.y);
                    return this._lastPoint = t.util.object.clone(this._point),
                    this._point = s,
                    s
                },
                _resetTip: function(i) {
                    var s, o, n, e;
                    for (o = this.setPointer(i),
                    s = this._strokes = [],
                    this.size = this.width / 5 + this._baseWidth,
                    this._strokeNum = this.size,
                    this._range = this.size / 2,
                    e = 0,
                    n = this._strokeNum; n > e; e++)
                        s[e] = new t.Stroke(this.canvas.contextTop,o,this._range,this.color,this.width,this._inkAmount)
                }
            })
        }(fabric);
    }
    ...
    4: [function(require, module, exports) {
        !function(t) {
            t.MarkerBrush = t.util.createClass(t.BaseBrush, {
                color: "#000000",
                opacity: 1,
                width: 30,
                _baseWidth: 10,
                ...
                initialize: function(i, n) {
                    n = n || {},
                    this.canvas = i,
                    this.width = n.width || i.freeDrawingBrush.width,
                    this.color = n.color || i.freeDrawingBrush.color,
                    this.opacity = n.opacity || i.contextTop.globalAlpha,
                    this._point = new t.Point,
                ...
                _render: function(i) {
                    var n, o, s;
                    for (n = this.canvas.contextTop,
                    n.beginPath(),
                    s = 0,
                    len = this._size / this._lineWidth / 2; s < len; s++)
                        o = (this._lineWidth - 1) * s,
                        n.globalAlpha = .8 * this.opacity,
                        n.moveTo(this._lastPoint.x + o, this._lastPoint.y + o),
                        n.lineTo(i.x + o, i.y + o),
                        n.stroke();
                    this._lastPoint = new t.Point(i.x,i.y)
                },
                onMouseDown: function(t) {
                    this._lastPoint = t,
    ...
    5: [function(require, module, exports) {
        !function(s) {
            s.SprayBrush = s.util.createClass(s.BaseBrush, {
                color: "#000000",
                opacity: 1,
                width: 30,
                _baseWidth: 40,
                ...
                initialize: function(A, B) {
                    ...
                    this.canvas.contextTop.lineCap = "round",
                    this._reset(),
                    s.Image.fromURL(this.sprayBrushDataUrl, function(s) {
                        t.brush = s,
                        t.brush.filters = [],
                        t.changeColor(t.color || this.color)
                    }, {
                ...
                changeColor: function(A) {
                    this.color = A,
                    this.brush.filters[0] = new s.Image.filters.Tint({
                        color: A
                    }),
                    this.brush.applyFilters(this.canvas.renderAll.bind(this.canvas))
                },
                changeOpacity: function(s) {
                    this.opacity = s,
                    this.canvas.contextTop.globalAlpha = s
                },
                onMouseDown: function(A) {
                    this._point = new s.Point(A.x,A.y),
                ...
                _render: function() {
                    function A() {
                        var t, J, W, w, g, m;
                        t = new s.Point(B._point.x || 0,B._point.y || 0),
                        J = t.distanceFrom(B._lastPoint),
                        W = t.angleBetween(B._lastPoint),
                        w = 100 / B.size / (Math.pow(J, 2) + 1),
                        B._inkAmount += w,
                        B._inkAmount = Math.max(B._inkAmount - J / 10, 0),
                        B._inkAmount > B._dripThreshold && (B._drips.push(new s.Drip(B.canvas.contextTop,t,B._inkAmount / 2,B.color,B._strokeId)),
                        B._inkAmount = 0),
                        g = B._lastPoint.x + Math.sin(W) - B.size / 2,
                        m = B._lastPoint.y + Math.cos(W) - B.size / 2,
                        B.canvas.contextTop.drawImage(B.brush._element, g, m, B.size, B.size),
    ...
    6: [function(require, module, exports) {
        !function(t) {
            t.Stroke = t.util.createClass(t.Object, {
                color: null,
                inkAmount: null,
                lineWidth: null,
                _point: null,
                ...
                initialize: function(i, n, o, e, l, h) {
                    var s = t.util.getRandom(o)
                      , a = t.util.getRandom(2 * Math.PI)
                      , u = t.util.getRandom(2 * Math.PI)
                      , r = s * Math.sin(u)
                      , c = s / 2 * Math.cos(u)
                      , d = Math.cos(a)
                      , _ = Math.sin(a);
                    this.ctx = i,
                    this.color = e,
                    this._point = new t.Point(n.x + r * d - c * _,n.y + r * _ + c * d),
                    this.lineWidth = l,
                    this.inkAmount = h,
                    this._currentLineWidth = l,
                    i.lineCap = "round"
                },
                update: function(i, n, o) {
                    ...
                    var e = this.inkAmount / (o + 1)
                      , l = e > .3 ? .2 : 0 > e ? 0 : e;
                    this._currentLineWidth = this.lineWidth * l
                },
                draw: function() {
                    var t = this.ctx;
                    t.save(),
                    this.line(t, this._lastPoint, this._point, this.color, this._currentLineWidth),
                    t.restore()
                },
                line: function(t, i, n, o, e) {
                    t.strokeStyle = o,
                    t.lineWidth = e,
                    t.beginPath(),
                    t.moveTo(i.x, i.y),
    ...
    7: [function(require, module, exports) {
        !function(t) {
            t.Point.prototype.angleBetween = function(t) {
                return Math.atan2(this.x - t.x, this.y - t.y)
            }
            ,
            t.Point.prototype.normalize = function(t) {
                (null === t || void 0 === t) && (t = 1);
                var i = this.distanceFrom({
                    x: 0,
                    y: 0
                });
                return i > 0 && (this.x = this.x / i * t,
                this.y = this.y / i * t),
                this
            }
        }(fabric);
    ...
    8: [function(require, module, exports) {
        !function(n) {
            n.util.getRandom = function(n, t) {
                return t = t ? t : 0,
                Math.random() * ((n ? n : 1) - t) + t
            }
            ,
            n.util.clamp = function(n, t, u) {
